...
class AutoGenAPIModelTest(FixtureTestCase):
    ...
    def test_model_as_nested_dict_with_list(self, api, client, user_model_with_relations):

        person = api.model(
            "Person",
            gen_api_model_from_db(api, user_model_with_relations)
        )
    ...
    def test_model_as_nested_dict_with_list_limited_fields(self, api, client, user_model_with_relations):
        ...
        assert data["definitions"]["Person"] == {
            'properties': {
                ...
                'addresses': {'type': 'array', 'items': {'$ref': '#/definitions/NestedAddresses'}}
            },
            'type': 'object'
        }
    ...
    def test_model_as_deep_nested_dict_with_list_limited_fields(self, api, client, models_with_deep_nested_relations):

        person = api.model(
            "Person",
            gen_api_model_from_db(
                api, models_with_deep_nested_relations['person'])
        )
        ...
        assert data["definitions"]["NestedAddresses"] == {
            'properties': {
                'id': {'type': 'integer'},
                'road': {'type': 'string'},
                'country': {'type': 'array', 'items': {'$ref': '#/definitions/NestedCountry'}}
            },
            'type': 'object'
        }
    ...
    def test_model_as_deep_nested_dict_with_list_static_fields(self, api, client, models_with_deep_nested_relations):
        ...
        person = api.model(
            "Person",
            {
                **gen_api_model_from_db(api, models_with_deep_nested_relations['person'], fields=('id', 'name', 'birth_date')),
        ...
        assert data["definitions"]["Person"] == {
            'properties': {
                ...
                'name': {'type': 'string'},
                'birthDate': {'format': 'date-time', 'type': 'string'},
                'customAddressesFieldName': {'type': 'array', 'items': {'$ref': '#/definitions/Addresses'}},
                'customCountriesFieldName': {'type': 'array', 'items': {'$ref': '#/definitions/Countries'}}
            },
            'type': 'object'
        }
    ...
    def test_declarative_model_as_deep_nested_dict_with_list_limited_fields(self, api, client, declarative_models_with_deep_nested_relations):
        return self.test_model_as_deep_nested_dict_with_list_limited_fields(api, client, declarative_models_with_deep_nested_relations)

    def test_declarative_model_as_deep_nested_dict_with_list_static_fields(self, api, client, declarative_models_with_deep_nested_relations):
        return self.test_model_as_deep_nested_dict_with_list_static_fields(api, client, declarative_models_with_deep_nested_relations)